            ...
            <header className="main-header">
                <div className="navbar-container">
                    ...
                    <div className="search-container">
                        ...
                        <button className="search-button">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 111-14 0 7 7 0 0114 0z" />
                            </svg>
                        </button>
                    </div>
                    ...
                    <nav className="nav-links">
                        ...
                        <div className="dropdown">
                            <button className="nav-item">
                                <span>Kapil</span>
                                <svg className="h-4 w-4 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: "16px", height: "16px", marginLeft: "4px" }}>
                            ...
                            <div className="dropdown-menu">
                                ...
                                <a href="#" className="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2z"></path></svg>
                                    Flipkart Plus Zone
                                </a>
                                <a href="#" className="dropdown-item">
                        ...
                        <a href="#" className="nav-item">Become a Seller</a>
                        ...
                        <div className="dropdown">
                            ...
                            <div className="dropdown-menu">
                                ...
                                <a href="#" className="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><circle cx="12" cy="12" r="10"></circle></svg>
                                    24x7 Customer Care
                                </a>
                                <a href="#" className="dropdown-item">
                        ...
                        <a href="#" className="nav-item">
                            <svg className="h-5 w-5 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: "20px", height: "20px", marginRight: "4px" }}>
                    ...
                    <div className="mobile-menu-button">
                        <button>
                            <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: "24px", height: "24px" }}>
