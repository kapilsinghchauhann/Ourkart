      ...
      <nav className="header-nav">
        <div className="header-top">
          ...
          <Link to="/MinutesPage" className="logo">
            <img src="src\MinutesPage\fkheaderlogo_minutes_desktop-bc73ae.svg" alt="LOGO" />
          </Link>
        ...
        {isMenuOpen && (
          <div className="mobile-menu">
            <a href="#" className="mobile-link"><LoginIcon /> <span>Login</span></a>
            <a href="#" className="mobile-link"><CartIcon /> <span>Cart</span></a>
            <a href="#" className="mobile-link"><BackArrowIcon /> <span>Back to FLIPKART</span></a>
          </div>
        )}
      </nav>
    </header>
